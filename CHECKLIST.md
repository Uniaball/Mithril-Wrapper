...
- 分组（docs/gl33_core_list.md，按实现里程碑）：
    ...
    - S6 同步/Query/Sampler：36（glGenQueries/glFenceSync/glSamplerParameter 系；**S6 19/36 完成：sync 6 + query 13，query_smoke 60 断言通过**）
  - 342 全部归入以上六组，无遗漏
