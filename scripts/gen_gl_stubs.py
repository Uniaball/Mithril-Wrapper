...
MGL_IMPL = frozenset({
    ...
    # Stage F: the last 58 names -- S1 clear-buffer/get-multisample,
    # S2 frag-data + uniform-block introspection, S3 transform feedback /
    # packed+integer constants / point params, S4 multisample textures,
    # S6 conditional rendering. All implemented for real in src/gl/.
    "glClearBufferfi", "glClearBufferfv", "glClearBufferiv", "glClearBufferuiv",
    "glGetMultisamplefv",
    "glBindFragDataLocation", "glBindFragDataLocationIndexed",
    "glGetFragDataIndex", "glGetFragDataLocation",
    "glGetActiveUniformBlockName", "glGetActiveUniformBlockiv",
    "glGetActiveUniformName", "glGetActiveUniformsiv",
    "glGetUniformBlockIndex", "glGetUniformIndices", "glUniformBlockBinding",
